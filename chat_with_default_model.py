#!/usr/bin/env python3
"""
Example script to use the default qwen3:1.7b model for chat interactions
"""
import requests
import json
import os
...
def main():
    ...
    client = OllamaChatClient(model_name="qwen3:1.7b")
    
    print("Ollama Chat Client with qwen3:1.7b (Default Model)")
    print("=" * 50)
    ...
    print("\nYou can now use qwen3:1.7b as the default model in your applications!")
